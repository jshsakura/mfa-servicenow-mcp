...
<div class="section reveal" id="story">
  <div class="section-inner">
    ...
    <p class="section-desc">
      ただ、APIキーはこの用途には合わない方式だと感じました — 設定ファイルに埋め込まれ、本来の作業が
      終わった後も残り続ける静的な秘密情報だからです。管理者に本当に必要なのは、実際の管理者がすでに
    ...
    <div class="feature-grid reveal-stagger">
      ...
      <div class="step-card" style="--i:2">
        <h3>🔑 秘密情報ではなくセッション</h3>
        <p>ServiceNow向けのブラウザ認証に対応したMCPがありませんでした。エージェントはAPIキーの代わりに、実際の管理者セッション — MFA、SSO、SAML — をそのまま引き継ぎます。</p>
      </div>
