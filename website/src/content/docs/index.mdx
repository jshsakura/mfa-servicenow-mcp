...
<div class="section reveal" id="story">
  <div class="section-inner">
    ...
    <h2 class="section-title">No MCP did browser-based auth for ServiceNow admins.<br />So I built one.</h2>
    <p class="section-desc">
      ...
      accurately, before touching anything.<br />
    ...
    <p class="section-desc">
      The Table API alone wasn't enough for that diagnosis.<br />
      Flow Designer's real structure — triggers, actions, why a flow actually fired or didn't — lives
      behind session-only endpoints that ordinary REST auth can't reach.<br />
    ...
    <p class="section-desc">
      From there it stopped being an API wrapper.<br />
    ...
    <p class="section-desc" style="margin-bottom:24px;">
      ...
      agent can actually use.<br />
      I run this on my own ServiceNow portal work every day; the design choices come from what breaks
      in practice, not from a spec.
    </p>
