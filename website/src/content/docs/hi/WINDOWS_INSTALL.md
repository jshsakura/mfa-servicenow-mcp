---
title: "Windows इंस्टॉलेशन गाइड"
description: "Windows-specific installation notes, including Smart App Control workarounds."
slug: hi/WINDOWS_INSTALL
---
...
Smart App Control (SAC) एक Windows 11 फ़ीचर है जो केवल **साइन किए हुए या अन्यथा भरोसेमंद माने गए** एक्ज़ीक्यूटेबल्स को ही चलने देता है। `uvx` कोई स्थायी रूप से इंस्टॉल किया गया प्रोग्राम नहीं चलाता — हर एक रन पर वह एक **नया, बिना साइन किया हुआ अस्थायी एक्ज़ीक्यूटेबल** अनपैक करके लॉन्च करता है। ठीक यही चीज़ रोकने के लिए SAC बना है, इसलिए वह हर बार इसे ब्लॉक करता है। बार-बार कोशिश करने या `uv` को दोबारा इंस्टॉल करने से कुछ नहीं बदलता: डिज़ाइन के हिसाब से ही फ़ाइल हर रन पर नई और बिना साइन की होती है।
...
| `standard` | 31 | **(डिफ़ॉल्ट)** इंसिडेंट, चेंज, पोर्टल, लॉग, और सोर्स विश्लेषण में केवल-पढ़ने योग्य पैकेज |
| `service_desk` | 33 | standard + इंसिडेंट और चेंज ऑपरेशनल राइट्स |
| `portal_developer` | 50 | standard + पोर्टल, चेंजसेट, स्क्रिप्ट इंक्लूड, और लोकल-सिंक डिलीवरी वर्कफ़्लो |
| `platform_developer` | 44 | standard + वर्कफ़्लो, Flow Designer, UI पॉलिसी, इंसिडेंट/चेंज, और स्क्रिप्ट राइट्स |
| `full` | 61 | सबसे व्यापक पैकेज्ड सतह: सभी `manage_*` वर्कफ़्लो के साथ एडवांस्ड ऑपरेशन्स |
