...
<div class="section reveal" id="story">
  <div class="section-inner">
    ...
    <p class="section-desc">
      एक API की इसके लिए गलत तरह का क्रेडेंशियल लगा — एक स्टैटिक सीक्रेट जो कॉन्फ़िग फ़ाइल में बैठा
      रहता है, उस काम से भी ज़्यादा देर तक जिसके लिए वह बनाया गया था। एडमिन को वाकई जिसकी ज़रूरत है
      वह वही है जो एक असली एडमिन के पास पहले से है — एक असली, MFA/SSO/SAML से सुरक्षित सेशन। MCP
      इकोसिस्टम में ServiceNow के लिए ऐसा कुछ नहीं था, इसलिए यही इस प्रोजेक्ट का मूल ढांचा बन गया —
    ...
    <div class="feature-grid reveal-stagger">
      ...
      <div class="step-card" style="--i:2">
        ...
        <p>ServiceNow के लिए ब्राउज़र-आधारित ऑथ करने वाला कोई MCP नहीं था। एजेंट API की पकड़ने के बजाय एक लाइव एडमिन सेशन — MFA, SSO, SAML — विरासत में लेता है।</p>
      </div>
