...
<div class="section reveal" id="story">
  <div class="section-inner">
    ...
    <p class="section-desc">
      ...
      ग्राफ़।<br />
      असली काम कभी कोड बदलना नहीं था; यह सटीक रूप से पता लगाना था कि वाकई क्या टूटा है और क्यों, कुछ
      भी छूने से पहले।<br />
      जब एक AI एजेंट यह निदान भरोसेमंद तरीके से कर सकता था, तो अगला सवाल यह था कि क्या यह टेस्टिंग
      और डिप्लॉयमेंट तक सुरक्षित रूप से आगे जा सकता है।
    </p>
    <p class="section-desc">
      उस निदान के लिए सिर्फ़ Table API काफ़ी नहीं था।<br />
      Flow Designer की असली संरचना — ट्रिगर, एक्शन, यह कि कोई फ़्लो वाकई क्यों चला या नहीं चला —
      सेशन-ओनली एंडपॉइंट्स के पीछे रहती है, जहाँ सामान्य REST ऑथ नहीं पहुँच सकता।<br />
      इसलिए इस टूल को कॉन्फ़िग फ़ाइल में बैठे API की के बजाय असली ब्राउज़र ऑथेंटिकेशन तक बढ़ना पड़ा।<br />
      एडमिन को वाकई जिसकी ज़रूरत है वह वही है जो एक असली एडमिन के पास पहले से है — एक असली,
      MFA/SSO/SAML से सुरक्षित सेशन।<br />
      MCP इकोसिस्टम में ServiceNow के लिए ऐसा कुछ नहीं था, इसलिए यही इस प्रोजेक्ट का मूल ढांचा बन गया
      — एजेंट एक की पकड़ने के बजाय एक लाइव ब्राउज़र सेशन विरासत में लेता है।
    </p>
    <p class="section-desc">
      वहाँ से यह सिर्फ़ एक API रैपर नहीं रहा।<br />
      हर राइट उसी अनुशासन से गुज़रता है जो एक सावधान इंजीनियर हाथ से इस्तेमाल करता — लोकल-फर्स्ट,
      पुश करने से पहले लाइव सर्वर के साथ diff, एंकर किया हुआ ताकि टकराने वाला बदलाव चुपचाप ओवरराइट
      होने के बजाय पकड़ा जाए, और साबित करने योग्य — एक डिप्लॉय XML एक सर्टिफिकेट के साथ आता है जो
      दिखाता है कि वह वाकई लाइव इंस्टेंस से आया।
    </p>
    <p class="section-desc" style="margin-bottom:24px;">
      ...
      एजेंट वाकई इस्तेमाल कर सकता है।<br />
      मैं इसे अपने खुद के ServiceNow Portal काम पर हर दिन चलाता हूँ। डिज़ाइन के फ़ैसले किसी स्पेक से
      नहीं, बल्कि व्यवहार में जो टूटा उससे आए हैं।
    </p>
