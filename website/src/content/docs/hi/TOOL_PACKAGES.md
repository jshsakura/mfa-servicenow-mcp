...
| `portal_developer` | 50 | ~10.6K | ⚠️ पोर्टल डेवलपर जो widgets, changesets, और script includes परिनियोजित करते हैं |
| `platform_developer` | 44 | ~10.8K | ⚠️ प्लेटफ़ॉर्म इंजीनियर जो workflows, Flow Designer, और scripts प्रबंधित करते हैं |
| `full` | 61 | ~13.8K | ⚠️ सबसे उन्नत — सभी डोमेन में सभी लेखन टूल्स एक साथ (नीचे चेतावनी देखें) |
...
- आप पैकेज द्वारा सक्रिय किए जाने वाले हर लेखन टूल को समझते न हों ([Tool Inventory](../TOOL_INVENTORY/) देखें)
...
सभी 73 टूल्स की श्रेणी और पैकेज सदस्यता के अनुसार पूर्ण सूची के लिए, [Tool Inventory](../TOOL_INVENTORY/) देखें।
