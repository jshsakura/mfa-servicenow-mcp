...
<div class="section reveal" id="story">
  <div class="section-inner">
    ...
    <h2 class="section-title">Ningún MCP hacía autenticación por navegador para administradores de ServiceNow.<br />Así que hice uno.</h2>
    <p class="section-desc">
      ...
      realmente roto y por qué, antes de tocar nada.<br />
    ...
    <p class="section-desc">
      Solo con la Table API no bastaba para ese diagnóstico.<br />
    ...
    <p class="section-desc">
      A partir de ahí dejó de ser un simple envoltorio de API.<br />
    ...
    <p class="section-desc" style="margin-bottom:24px;">
      ...
      que el agente realmente puede usar.<br />
      Uso esto todos los días en mi propio trabajo con ServiceNow Portal. Las decisiones de diseño
      vienen de lo que se rompe en la práctica, no de una especificación.
    </p>
