...
<div class="section reveal" id="story">
  <div class="section-inner">
    ...
    <p class="section-desc">
      그 진단을 위해서는 Table API만으로는 부족했습니다.<br />
      Flow Designer의 실제 구조 — 트리거, 액션, 플로우가 왜 실행됐는지 안 됐는지 — 는 일반 REST
      인증으로는 닿을 수 없는 세션 전용 엔드포인트 뒤에 있습니다.<br />
    ...
    <p class="section-desc">
      거기서부터 이건 단순한 API 래퍼가 아니게 됐습니다.<br />
    ...
    <p class="section-desc" style="margin-bottom:24px;">
      ...
      실제로 쓸 수 있는 만큼만 노출됩니다.<br />
      저는 이걸 제 실제 ServiceNow 포털 업무에 매일 씁니다. 설계 결정들은 스펙이 아니라 실전에서
      깨진 것들에서 나왔습니다.
    </p>
