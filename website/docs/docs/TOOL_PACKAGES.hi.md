...
| Package | Tools | कब उपयोग करें |
| :--- | :---: | :--- |
| `core` | 12 | न्यूनतम केवल-पठन: केवल health, schema, discovery, और मुख्य artifact लुकअप |
| `standard` | 27 | **(डिफ़ॉल्ट)** incidents, changes, portal, logs, और source विश्लेषण में केवल-पठन |
| `none` | 0 | जानबूझकर सभी टूल्स अक्षम करें (परीक्षण, प्रतिबंधित वातावरण) |

⚠️ लेखन-सक्षम — **उन्नत विकल्प** जो create/update/delete की अनुमति देते हैं:

| Package | Tools | कब उपयोग करें |
| :--- | :---: | :--- |
| `service_desk` | 29 | ⚠️ सर्विस डेस्क एजेंट जिन्हें incidents और changes को अपडेट/बंद करने की आवश्यकता हो |
| `portal_developer` | 39 | ⚠️ पोर्टल डेवलपर जो widgets, changesets, और script includes परिनियोजित करते हैं |
| `platform_developer` | 39 | ⚠️ प्लेटफ़ॉर्म इंजीनियर जो workflows, Flow Designer, और scripts प्रबंधित करते हैं |
| `full` | 53 | ⚠️ सबसे उन्नत — सभी डोमेन में सभी लेखन टूल्स एक साथ (नीचे चेतावनी देखें) |
