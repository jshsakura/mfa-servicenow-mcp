...
| `portal_developer` | 46 | ~10.6K | ⚠️ 위젯, 체인지셋, Script Include를 배포하는 포털 개발자 |
| `platform_developer` | 43 | ~10.8K | ⚠️ 워크플로우, Flow Designer, 스크립트를 관리하는 플랫폼 엔지니어 |
| `full` | 57 | ~13.8K | ⚠️ 가장 고급 — 모든 도메인의 쓰기 도구 전체를 동시에 (아래 경고 참고) |
