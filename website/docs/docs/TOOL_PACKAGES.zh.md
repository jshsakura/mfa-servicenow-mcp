...
| `portal_developer` | 46 | ~10.6K | ⚠️ 部署 widget、变更集和 script include 的门户开发者 |
| `platform_developer` | 43 | ~10.8K | ⚠️ 管理工作流、Flow Designer 和脚本的平台工程师 |
| `full` | 57 | ~13.8K | ⚠️ 最高级 —— 同时启用所有领域的所有写入工具（见下方警告） |
