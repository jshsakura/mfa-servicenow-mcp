...
| Paquete | Herramientas | Cuándo usarlo |
| :--- | :---: | :--- |
| `core` | 12 | Solo lectura mínima: salud, esquema, descubrimiento y consultas de artefactos clave únicamente |
| `standard` | 27 | **(Predeterminado)** Solo lectura en incidentes, cambios, portal, registros y análisis de código fuente |
| `none` | 0 | Deshabilitar intencionadamente todas las herramientas (pruebas, entornos restringidos) |

⚠️ Con capacidad de escritura — **opciones avanzadas** que conceden crear/actualizar/eliminar:

| Paquete | Herramientas | Cuándo usarlo |
| :--- | :---: | :--- |
| `service_desk` | 29 | ⚠️ Agentes de mesa de servicio que necesitan actualizar/cerrar incidentes y cambios |
| `portal_developer` | 39 | ⚠️ Desarrolladores de portal que despliegan widgets, changesets y script includes |
| `platform_developer` | 39 | ⚠️ Ingenieros de plataforma que gestionan flujos de trabajo, Flow Designer y scripts |
| `full` | 53 | ⚠️ El más avanzado — todas las herramientas de escritura en todos los dominios a la vez (consulta la advertencia más abajo) |
