...
| `portal_developer` | 46 | ~10.6K | ⚠️ Portal developers who deploy widgets, changesets, and script includes |
| `platform_developer` | 43 | ~10.8K | ⚠️ Platform engineers who manage workflows, Flow Designer, and scripts |
| `full` | 57 | ~13.8K | ⚠️ Most advanced — all write tools across all domains at once (see warning below) |
