...
| `standard` | 29 | ~7.3K | **(Predeterminado)** Solo lectura en incidentes, cambios, portal, registros y análisis de código fuente |
...
| Paquete | Herramientas | ~Tokens | Cuándo usarlo |
| :--- | :---: | :---: | :--- |
| `service_desk` | 31 | ~8.2K | ⚠️ Agentes de mesa de servicio que necesitan actualizar/cerrar incidentes y cambios |
| `portal_developer` | 41 | ~10.6K | ⚠️ Desarrolladores de portal que despliegan widgets, changesets y script includes |
| `platform_developer` | 41 | ~10.8K | ⚠️ Ingenieros de plataforma que gestionan flujos de trabajo, Flow Designer y scripts |
| `full` | 55 | ~13.8K | ⚠️ El más avanzado — todas las herramientas de escritura en todos los dominios a la vez (consulta la advertencia más abajo) |
