...
| Tool | R/W | Description | Packages |
|------|-----|-------------|----------|
| `workspace_brief` | R | Session brief: who/where, your local edits & conflicts, and which trees need a refresh. | standard, portal_developer, platform_developer, service_desk, full |
