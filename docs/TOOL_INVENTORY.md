...
Registered tools in the live registry: **138**
Packaged tool count in `full`: **100**
...
| `full` | 100 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
