...
Registered tools in the live registry: **75**
Packaged tool count in `full`: **60**
...
| `full` | 60 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
...
| Tool | R/W | Description | Packages |
|------|-----|-------------|----------|
| `manage_workbook` | W | Excel without boilerplate: list/read/regex-find rows; write styled sheets from a data spec; fill a copy of an existin... | portal_developer |
