...
Registered tools in the live registry: **155**
Packaged tool count in `full`: **117**
...
| `platform_developer` | 96 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 117 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
