...
Registered tools in the live registry: **88**
Packaged tool count in `full`: **66**
Registered but currently unpackaged tools: **22**
...
`create_category`, `create_epic`, `create_knowledge_base`, `create_project`, `create_scrum_task`, `create_story`, `create_story_dependency`, `delete_story_dependency`, `get_developer_daily_summary`, `get_repo_file_last_modifier`, `get_repo_recent_commits`, `get_repo_working_tree_status`, `get_uncommitted_changes`, `list_epics`, `list_projects`, `list_scrum_tasks`, `list_stories`, `list_story_dependencies`, `update_epic`, `update_project`, `update_scrum_task`, `update_story`
