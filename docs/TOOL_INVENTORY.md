...
Active tools: **86** | Registered in code: **124** | Removed from packages: **38**
...
|---------|-------|---------|-------------|
| `none` | 0 |  | Disabled |
| `standard` | 48 | Y | Read-only safe mode |
| `portal_developer` | 58 |  | Portal/Widget development |
| `platform_developer` | 71 |  | Backend/Workflow development |
| `service_desk` | 52 |  | Incident operations |
| `full` | 86 |  | All capabilities |
...
### Change Management (12) — 1 removed
...
| `get_workflow_activities` | R | Get ordered activity list for a workflow version. Defaults to latest published v... | full, platform_developer, portal_developer, service_desk, standard |
| `get_workflow_details` | R | Get a single workflow by sys_id with full configuration and metadata. | full, platform_developer, portal_developer, service_desk, standard |
| `list_workflow_versions` | R | List version history for a workflow. Returns version records with publish status... | full, platform_developer, portal_developer, service_desk, standard |
