...
Registered tools in the live registry: **159**
Packaged tool count in `full`: **121**
...
| `platform_developer` | 98 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 121 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
