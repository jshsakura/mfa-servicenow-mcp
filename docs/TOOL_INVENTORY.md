...
Registered tools in the live registry: **78**
Packaged tool count in `full`: **67**
...
| `platform_developer` | 56 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 67 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
