...
Registered tools in the live registry: **144**
Packaged tool count in `full`: **106**
...
| `portal_developer` | 79 | standard plus portal, changeset, script include, and local-sync delivery workflows. |
| `platform_developer` | 85 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 106 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
