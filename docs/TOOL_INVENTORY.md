...
Registered tools in the live registry: **125**
Packaged tool count in `full`: **93**
...
| `portal_developer` | 72 | standard plus portal, changeset, script include, and local-sync delivery workflows. |
| `platform_developer` | 80 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 93 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
