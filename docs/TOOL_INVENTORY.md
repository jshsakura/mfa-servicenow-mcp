...
Registered tools in the live registry: **79**
Packaged tool count in `full`: **68**
...
| `standard` | 46 | Default read-only package across incidents, changes, portal, logs, and source analysis. |
| `service_desk` | 47 | standard plus incident and change write workflows for operational support. |
| `portal_developer` | 58 | standard plus portal, changeset, script include, and local-sync delivery workflows. |
| `platform_developer` | 57 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 68 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
...
| Tool | R/W | Description | Packages |
|------|-----|-------------|----------|
| `capture_screenshot` | R | Full-page screenshot of a ServiceNow page. Browser auth only. Returns saved file path. | standard, portal_developer, platform_developer, service_desk, full |
...
| `get_flow_designer_detail` | R | Get Flow Designer workflow detail. summary_format=True by default (compact). Pass False for raw dump. | standard, portal_developer, platform_developer, service_desk, full |
...
| Tool | R/W | Description | Packages |
|------|-----|-------------|----------|
| `manage_flow_edit` | W | Checkout/patch/save Flow Designer flows. Browser auth only. checkout→patch→save workflow. | platform_developer, full |
