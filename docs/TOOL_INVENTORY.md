...
Registered tools in the live registry: **118**
Packaged tool count in `full`: **86**
...
| `platform_developer` | 74 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 86 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
