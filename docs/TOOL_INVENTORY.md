...
Registered tools in the live registry: **153**
Packaged tool count in `full`: **115**
...
| `platform_developer` | 94 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 115 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
