...
Registered tools in the live registry: **162**
Packaged tool count in `full`: **124**
Registered but currently unpackaged tools: **38**
...
`add_group_members`, `create_category`, `create_epic`, `create_group`, `create_knowledge_base`, `create_project`, `create_scrum_task`, `create_story`, `create_story_dependency`, `create_user`, `delete_story_dependency`, `delete_workflow`, `get_article`, `get_developer_daily_summary`, `get_repo_file_last_modifier`, `get_repo_recent_commits`, `get_repo_working_tree_status`, `get_uncommitted_changes`, `get_user`, `get_workflow_activities`, `list_articles`, `list_categories`, `list_epics`, `list_groups`, `list_knowledge_bases`, `list_projects`, `list_scrum_tasks`, `list_stories`, `list_story_dependencies`, `list_users`, `list_workflow_versions`, `remove_group_members`, `update_epic`, `update_group`, `update_project`, `update_scrum_task`, `update_story`, `update_user`
