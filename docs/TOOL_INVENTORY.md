...
Registered tools in the live registry: **149**
Packaged tool count in `full`: **111**
...
| `portal_developer` | 84 | standard plus portal, changeset, script include, and local-sync delivery workflows. |
| `platform_developer` | 90 | standard plus workflow, Flow Designer, UI policy, incident/change, and script writes. |
| `full` | 111 | Broadest packaged surface: all manage_* workflows plus advanced operations. |
