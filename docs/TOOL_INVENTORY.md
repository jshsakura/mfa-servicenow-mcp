...
Registered tools in the live registry: **69**
...
| `portal_developer` | 44 | standard plus portal, changeset, script include, and local-sync delivery workflows. |
