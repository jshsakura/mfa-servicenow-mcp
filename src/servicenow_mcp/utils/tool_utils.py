...
def get_tool_definitions(
    ...
    tool_definitions: Dict[str, ToolDefinition] = {
        ...
        "sn_query": (
            ...
            GenericQueryParams,
            Dict[str, Any],
            "Run generic query against any ServiceNow table",
            "raw_dict",
        ),
        "sn_aggregate": (
            sn_aggregate_tool,
            AggregateParams,
            Dict[str, Any],
            "Run aggregate statistics (count/sum/avg/min/max)",
            "raw_dict",
        ),
        "sn_schema": (
            sn_schema_tool,
            SchemaParams,
            Dict[str, Any],
            "Fetch table schema from sys_dictionary",
            "raw_dict",
        ),
        "sn_discover": (
            sn_discover_tool,
            DiscoverParams,
            Dict[str, Any],
            "Discover tables by name or label keyword",
            "raw_dict",
        ),
        "sn_nl": (
            sn_nl_tool,
