...
from .core_plus import sn_query_all as _sn_query_all_shared
...
class DetectMissingCodesParams(BaseModel):
    ...
    widget_prefix: Optional[str] = Field(
        None,
        description="Widget id/name prefix to filter. Example: myapp (matches nameLIKEmyapp^ORidLIKEmyapp)",
    )
