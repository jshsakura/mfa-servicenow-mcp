...
class GetDeveloperChangesParams(BaseModel):
    developer: str = Field(
        ...,
        description="Developer username (sys_updated_by value). Example: dev@example.com",
    )
...
class GetUncommittedChangesParams(BaseModel):
    developer: Optional[str] = Field(
        None,
        description="Developer username (sys_updated_by on update set). Example: dev@example.com",
    )
    scope: Optional[str] = Field(
        None,
...
class GetProviderDependencyMapParams(BaseModel):
    ...
    developer: Optional[str] = Field(
        None,
        description="Developer filter (sys_updated_by). Example: dev@example.com",
    )
...
class GetDeveloperDailySummaryParams(BaseModel):
    developer: str = Field(
        ...,
        description="Developer username (sys_updated_by). Example: dev@example.com",
    )
    date: str = Field(
        ...,
