...
- **PyPI पहुँच योग्य है, लेकिन HTTPS TLS-निरीक्षित है** (Zscaler / Netskope / कॉर्पोरेट MITM) → ठीक नीचे **TLS-निरीक्षण करने वाले proxy के पीछे install** देखें।
- **PyPI स्वयं ब्लॉक है** → और नीचे **Release zip/exe (local install)** देखें।
...
इस path का उपयोग तब करें जब PyPI स्वयं कॉर्पोरेट सुरक्षा द्वारा ब्लॉक किया गया हो। release zip एक **PyInstaller-निर्मित single-file executable** भेजता है — कोई Python आवश्यक नहीं, कोई installer script नहीं, कोई system-cache प्रदूषण नहीं। executable अपने बगल में रखी `ms-playwright/` डायरेक्टरी को स्वतः-पहचानता है, इसलिए पूरा install "unzip करें और अपने MCP क्लाइंट को इसकी ओर इंगित करें" है।
...
[Setup](https://github.com/jshsakura/mfa-servicenow-mcp#setup) वाली ही क्लाइंट कॉन्फ़िग का पुनः उपयोग करें — केवल `command` आपके executable के absolute path में बदलता है और `args` `[]` हो जाता है; `env` block समान रहता है। Claude Code उदाहरण:
