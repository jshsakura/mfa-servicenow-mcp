...
> Windows 사용자라면 [Windows 설치 가이드](./docs/WINDOWS_INSTALL.ko.md)를 확인하세요.
...
- 성능: orjson 직렬화, 병렬 페이지네이션, 배치 API, LRU 캐시, 레이지 도구 디스커버리 ([성능 최적화](#성능-최적화) 참조)
- 주요 ServiceNow 아티팩트 테이블 완전 지원 (아래 참조)

### 지원 ServiceNow 테이블

| 아티팩트 유형 | 테이블명 | 소스 검색 | 개발자 추적 | 안전 장치 (Heavy Table) |
|--------------|----------|:---:|:---:|:---:|
...
> Windows 설치: [docs/WINDOWS_INSTALL.ko.md](./docs/WINDOWS_INSTALL.ko.md)

## 상세 문서

- [Windows 설치 가이드](docs/WINDOWS_INSTALL.ko.md)
- [도구 목록](docs/TOOL_INVENTORY.md)
